...
const services = [
  ...
  { label: "Automotive EMC Testing", href: "/services/automotive" as const, isSlug: true },
...
export default function LocationCoimbatore() {
  return (
      ...
      >
        <div className="absolute inset-0 -z-10">
          <img
            ...
            alt="CCTL Coimbatore EMC test chamber"
        ...
        <div className="relative flex min-h-[inherit] flex-col justify-end px-6 pb-14 pt-32 sm:px-10 lg:px-16">
          ...
          >
            EMC Testing Laboratory — Coimbatore
          </motion.h1>
          ...
          >
            ...
            Coimbatore, Tamil Nadu and across India.
          </motion.p>
        </div>
      </section>
      ...
      <section className="container-x pb-0 pt-0">
        <div className="mx-auto max-w-5xl">
          <Reveal className="surface overflow-hidden rounded-[1.5rem]">
            <iframe
              title="CCTL Coimbatore Laboratory Location"
            ...
            <div className="flex items-center justify-between gap-4 p-6">
              <p className="text-[0.875rem] font-semibold text-ink-300">
                Annamalai Industrial Park, Kalapatti, Coimbatore
              </p>
              <a
      ...
      <section className="container-x section-y bg-space-900">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <h2 className="t-h2 mt-5">Testing Capabilities at Coimbatore</h2>
            <p className="t-lead mt-6 max-w-2xl">
              The Coimbatore laboratory provides comprehensive EMI/EMC testing services
              across multiple industry sectors from its accredited facility in Tamil Nadu.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <p className="t-small mt-8 max-w-2xl border-l-2 border-cyan-glow/40 pl-4">
              CCTL Coimbatore is NABL accredited and ISO/IEC 17025:2017 certified, and
              recognised as a Designated Test Facility.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="container-x section-y bg-space-950">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <h2 className="t-h2 mt-5">The Coimbatore Laboratory</h2>
          </Reveal>

          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { src: "/images/chamber.webp", alt: "CCTL semi-anechoic EMC test chamber, Coimbatore" },
              { src: "/images/explore/control_room.webp", alt: "Test control room with EMI receiver and measurement instrumentation" },
              { src: "/images/explore/RE102 setup.webp", alt: "Radiated emissions test setup with antenna mast" },
            ].map((photo, i) => (
              <Reveal
                key={photo.src}
                delay={i * 0.1}
      ...
      <section className="container-x section-y bg-space-900">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <h2 className="t-h2 mt-5">Testing Services at Coimbatore</h2>
          </Reveal>
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal className="surface glow-border flex flex-col items-start gap-6 rounded-[1.5rem] p-8 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="t-h3 text-lg">Also available in Bangalore</p>
                <p className="t-body mt-2 max-w-sm">
                  CCTL operates a second laboratory in Bangalore, Karnataka — same accreditation,
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <h2 className="font-display mt-5 max-w-2xl text-[clamp(2rem,4vw,3.4rem)] font-extrabold leading-[1.03] tracking-[-0.036em] text-[#0f172a]">
              Book Testing at Coimbatore
            </h2>
            <p className="mt-5 max-w-xl text-[0.9125rem] leading-[1.75] text-[#475569]">
              Contact the Coimbatore laboratory directly to discuss your EMC testing
